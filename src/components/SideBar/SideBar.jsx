...
const SideBar = () => {
  return (
    <div className="">
      ...
      <div
        id="default-sidebar"
        class="fixed w-1/4 top-0 left-0 z-40  h-screen transition-transform -translate-x-full sm:translate-x-0"
        aria-label="Sidebar"
      >
        <div class="h-full px-3 py-4 overflow-y-auto bg-[#ffffff] space-x-4">
          <Image
            alt="logo"
            width={100}
            height={100}
